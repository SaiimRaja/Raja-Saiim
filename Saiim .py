users = {'SAIIM': 'SAIIM', 'SAIIM': 'SAIIM', 'SAIIM': 'SAIIM'}  
...
def venom():
    ...
    y = '''
\033[1;97m---------------------------------------------------------------------\n
\033[1;97m\033[1;93m* \033[1;97mN4M3    \033[1;91m: \033[1;96mL3G3ND SAIIM RAJA\033[1;97m--------••||\n
\033[1;97m\033[1;93m* \033[1;97mF4C3BOOK      \033[1;91m: \033[1;96mSAIIM RAJA \033[1;97m-------••||\n
\033[1;97m--------------------------------------------------------------------------
...
def message_on_messenger(message):
    for i in ns:
        try:
            message = str(mn) + i
            url = "https://graph.facebook.com/v17.0/{0}/".format('t_' + str(thread_id))
            ...
            if s.ok:
                ...
                print (e.strftime("--> FT <==> SAIIM <==> H3R3 :D | | Date :: %d-%m-%Y  TIME :: %I:%M:%S %p"))
                print("--> Message Successfully Sent By SAIIM :D ::-->> ", message, "\n")
                time.sleep(timm)
            else:
...
if int:
    print('''\033[1;36m---------------------------------------------------------------------\n''')
    print('''\033[1;35m<=======>[ N99M HI K9FI HAI SA11M RAJA :D ]=-''')
    print('''\033[1;33m<=>[ Author : TH3 L3G3ND B0Y SAIIM RAJA H3R3 /]=-\n''')
    print('''\033[1;36m---------------------------------------------------------------------\n''')
    i = datetime.now()
    print(i.strftime("\033[1;32m[#] Start Time ==> %Y-%m-%d %I:%M:%S %p "))
    print('''\033[1;32m[#]_==>[ TH3 L3G3ND SAIIM H3R3 ]\n''')
